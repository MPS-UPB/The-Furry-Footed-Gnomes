...
public class GUI extends JFrame {
	...
	public GUI(String start, String end, String execLoc,String schemaLoc, String outLoc){
		exeDir = execLoc;
		schemaDir = schemaLoc;
		outDir = outLoc;
		int max=0;
		...
		mainWindow=new JPanel(new GridLayout(rows,2*max+1));setContentPane(mainWindow);
		int y=0;
