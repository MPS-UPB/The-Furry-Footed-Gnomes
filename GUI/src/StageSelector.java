...
public class StageSelector extends JDialog {
	...
	public String numehaha;
	public String numehaha1;
	public String numehaha2;
	/**
	...
	public StageSelector() {
		numehaha=new String();
		numehaha1=new String();
		numehaha2=new String();
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					  public void actionPerformed(ActionEvent evt) {
						    GUI frame = new GUI((String)comboBox.getSelectedItem(),(String)comboBox_1.getSelectedItem(),numehaha,numehaha1,numehaha2);
							System.out.println(numehaha);							
